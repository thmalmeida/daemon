...
#define NTP_SERVER_00	"us.pool.ntp.org"
#define NTP_SERVER_01	"a.st1.ntp.br"
#define NTP_SERVER_02	"a.ntp.br"
#define NTP_SERVER_03	"gps.ntp.br"
...
int main( int argc, char* argv[ ] ) {
	...
	char* host_name = NTP_SERVER_01; // NTP server host-name.
